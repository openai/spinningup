...
import gym
import time
import spinup.algos.pytorch.ppo_shared.core as core
from spinup.algos.pytorch.ppo_shared.impala_cnn import ImpalaCNNActorCritic
        ...
        for t in tqdm(range(local_steps_per_epoch)):
            ...
            if terminal or epoch_ended:
                ...
                if timeout or epoch_ended:
                    _, v, _ = ac.step(torch.as_tensor(o[None], dtype=torch.float32, device=device))
                else:
                    v = 0
                buf.finish_path(v)
